...
class GoodSKU(BaseModel):
    ...
    unice = models.CharField(max_length=20, verbose_name='商品单位')
...
class IndexTypeGoodBanner(BaseModel):
    ...
    type = models.ForeignKey('GoodType', verbose_name='商品类型')
    sku = models.ForeignKey('GoodSKU', verbose_name='商品SKU')
    display_type = models.SmallIntegerField(default=1, choices=DISPLAY_TYPE_CHOICES, verbose_name='展示')
